...
namespace eventsFormsProject {
    ...
    public partial class eventsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usersRow AddusersRow(string username, string email, string number, string address) {
...
namespace eventsFormsProject.eventsDBDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([username], [email], [number], [address]) VALUES (@use" +
                "rname, @email, @number, @address);\r\nSELECT id, username, email, number, address " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [username] = @username, [email] = @email, [number] = @number, [address] = @address WHERE (([id] = @Original_id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT id, username, email, number, address FROM users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::eventsFormsProject.Properties.Settings.Default.eventsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, username, email, number, address FROM dbo.users";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[users] ([username], [email], [number], [address]) VALUES (@use" +
                "rname, @email, @number, @address);\r\nSELECT id, username, email, number, address " +
                "FROM users WHERE (id = SCOPE_IDENTITY())";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@number", global::System.Data.SqlDbType.NVarChar, 11, global::System.Data.ParameterDirection.Input, 0, 0, "number", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(eventsDBDataSet.usersDataTable dataTable) {
        ...
        public virtual eventsDBDataSet.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            eventsDBDataSet.usersDataTable dataTable = new eventsDBDataSet.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(eventsDBDataSet.usersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_username, string Original_email, string Original_number, string Original_address) {
        ...
        public virtual int Insert(string username, string email, string number, string address) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string email, string number, string address, int Original_id, string Original_username, string Original_email, string Original_number, string Original_address, int id) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string email, string number, string address, int Original_id, string Original_username, string Original_email, string Original_number, string Original_address) {
            return this.Update(username, email, number, address, Original_id, Original_username, Original_email, Original_number, Original_address, Original_id);
        }
        ...
        public virtual int InsertQuery(string username, string email, string number, string address) {
    ...
    public partial class adminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[admin] WHERE (([id] = @Original_id) AND ((@IsNull_userid = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[admin] ([userid], [password]) VALUES (@userid, @password);\r\nSE" +
                "LECT id, userid, password FROM admin WHERE (id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[admin] SET [userid] = @userid, [password] = @password WHERE (([id] = @Original_id) AND ((@IsNull_userid = 1 AND [userid] IS NULL) OR ([userid] = @Original_userid)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT id, userid, password FROM admin WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, userid, password FROM dbo.admin";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT id, userid, password FROM dbo.admin";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(eventsDBDataSet.adminDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual eventsDBDataSet.adminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            eventsDBDataSet.adminDataTable dataTable = new eventsDBDataSet.adminDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        public virtual int FillBy(eventsDBDataSet.adminDataTable dataTable) {
        ...
        public virtual eventsDBDataSet.adminDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            eventsDBDataSet.adminDataTable dataTable = new eventsDBDataSet.adminDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(eventsDBDataSet.adminDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userid, string password, int Original_id, string Original_userid, string Original_password, int id) {
            if ((userid == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        public virtual int Update(string userid, string password, int Original_id, string Original_userid, string Original_password) {
            return this.Update(userid, password, Original_id, Original_userid, Original_password, Original_id);
        }
    }
